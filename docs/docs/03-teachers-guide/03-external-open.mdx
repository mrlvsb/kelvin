...
External open allows you to open a Kelvin submit directly in your IDE or terminal.
...
3. [Generate your API token](https://kelvin.cs.vsb.cz/api_token) and store it in `~/.config/kelvin/token`
