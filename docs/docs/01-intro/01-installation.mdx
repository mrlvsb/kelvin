...
Create a Python virtual environment and install Kelvin’s dependencies.
...
To ensure that the code is formatted correctly and linted, you can install pre-commit (prek) hooks:

```bash
curl --proto '=https' --tlsv1.2 -LsSf https://github.com/j178/prek/releases/download/v0.3.2/prek-installer.sh | sh
```

and then enable hooks with their installation:
