...
<li class="nav-item dropdown">
  ...
  <ul class="dropdown-menu dropdown-menu-end shadow">
    <li><button on:click={selectTheme} class="d-flex dropdown-item" class:active={workingTheme == "auto"} data-theme="auto">
      <i class="me-1 bi bi-circle-half"></i>Auto<i class="opacity-75 ms-auto bi bi-check2" hidden={workingTheme != "auto"}></i>
    </button></li>
    <li><button on:click={selectTheme} class="d-flex dropdown-item" class:active={workingTheme == "light"} data-theme="light">
      <i class="me-1 bi bi-sun"></i>Light mode<i class="opacity-75 ms-auto bi bi-check2" hidden={workingTheme != "light"}></i>
    </button></li>
    <li><button on:click={selectTheme} class="d-flex dropdown-item" class:active={workingTheme == "dark"} data-theme="dark">
      <i class="me-1 bi bi-moon-stars"></i>Dark mode<i class="opacity-75 ms-auto bi bi-check2" hidden={workingTheme != "dark"}></i>
    </button></li>
  </ul>
</li>
